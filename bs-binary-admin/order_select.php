                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            <?php
                                ...
                                $orders = $data_user_order->select_all_order();
                            ...
                            <tr> 
                                ...
                                <td><strong><?php echo $order["Money_into"]; ?></strong></td>
                                <td>
                                    <select id="status_opt_<?php echo $order["ID_order"]; ?>"> 
                                    ...
                                    <button onclick=" let Status = document.getElementById('status_opt_<?php echo $order['ID_order'] ?>').value;
                                                        window.location = 'order_update.php?id=<?php echo $order['ID_order'] ?>&stt=' + Status;"
                                    >
                                        Cập nhật trạng thái
                                    </button>
                                </td>
                                <td>
                                    <a href="order_details.php?id=<?php echo $order['ID_order']; ?>">Xem chi tiết</a>
                                </td>
                            </tr>
                            <?php 
                                }
                    ...
                    <script>
                        function updateOrderStatus(orderId) {
                            var Status = document.getElementById('status_opt_' + orderId).value;
                            window.location = 'order_update.php?id=' + orderId + '&stt=' + encodeURIComponent(Status);
                        }
                    </script>
                </div>
            </div>
