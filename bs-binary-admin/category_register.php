    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            ...
            <div style="color: white;
                        ...
                        float: right;
                        font-size: 16px;"> First accessed: April 15, 2024 &nbsp; 
                ...
                <div class="col-md-12 col-sm-12 col-xs-24">
                    <div class="panel panel-info">
                        ...
                        <?php                                                                 
                            ...
                            if($data_category->insert_cate($_POST["txt_name"], $_POST["txt_description"])) {
                                 echo "<script> alert('Thêm Category thành công');  window.location='category_select.php'; </script>";
                                }
                            }
                        ?>
                    </div>
