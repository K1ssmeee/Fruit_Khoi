                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            $cont = $data_contact->select_all_cont();
                                            
                                            foreach($cont as $contact) {                                                                                       
                                        ?>
                                        <tr> 
                                            <td><?php echo $contact["ID_contact"] ?></td>
                                            <td><?php echo $contact["YourName"] ?></td>
                                            <td><?php echo $contact["Phone"] ?></td>
                                            <td><?php echo $contact["Email"] ?></td>
                                            <td><?php echo $contact["Message"] ?></td>
                                            <td><?php echo $contact["Date"] ?></td>
                                            <td> 
                                                <a href="contact_delete.php?id=<?php echo $contact["ID_contact"] ?>" 
                                                        onclick="return confirm('Xóa Contact này?')">
                                                    Delete
                                                </a>
                                            </td>
                                        </tr>
