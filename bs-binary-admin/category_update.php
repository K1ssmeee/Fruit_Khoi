        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu"  href="index123.html"><i class="fa fa-dashboard fa-3x"></i> Dashboard </a>
                    </li>
                    <li>
                ...
                <div class="col-md-12 col-sm-12 col-xs-24">
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <?php 
                                $data_cate = new data_category();
                                $cate_id = $_GET["id"];
                                $cate = ($data_cate->select_update_cate($cate_id))->fetch_assoc();
                            ?>

                            <form role="form" method="POST" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label> Name Category </label>
                                            <input class="form-control" type="text" name="txt_name" value = "<?php echo $cate["Name_cate"] ?>">
                                            <p class="help-block">Input name here.</p>
                                        </div>
                                        <div class="form-group">
                                            <label> Description Category </label>
                                            <textarea class="form-control" rows="3" name="txt_description"><?php echo $cate["Description_cate"] ?></textarea>
                                            <p class="help-block">Input description here.</p>
                                        </div>    
                                        <button type="submit" class="btn btn-info" name="btn_sub">
                                             Update data 
                                        </button>                  
                                </form>
                            </div>    
                                    ...
                                    <?php
                                        ...
                                        if(isset($_POST["btn_sub"])) {
                                            if($data_cate->update_cate( $cate_id, $_POST["txt_name"], $_POST["txt_description"])) {
                                                echo "<script> alert('Sửa Category thành công'); 
