        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a style="background-color: #ff7700;"class="active-menu"  href="index123.html"><i class="fa fa-dashboard fa-3x"></i> Home </a>
                    </li>
                    <li>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                Advanced Tables
                                <a href="category_register.php" style="float: right;"> Add Category >> </a>
                            </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr> 
                                                ...
                                                <td> <?php echo $category["Description_cate"] ?> </td>

                                                <td> 
                                                    <a href="category_update.php?id=<?php echo $category["ID_cate"] ?>"> Update </a> |
                                                    <a href="category_delete.php?id=<?php echo $category["ID_cate"] ?>&name=<?php echo $category["Name_cate"] ?>" 
                                                        onclick=
                                                            "if(confirm('Xóa Category này? Nếu xóa, tất cả Product thuộc Category này sẽ bị xóa theo!!!')) {
                                                                return true;
                                                            } else {
                                                                return false;
                                                            }">                 
