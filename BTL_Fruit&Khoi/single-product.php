<?php 
  ...
  $product = ($data_product->select_product($_GET["id"]))->fetch_assoc();
?>
<!DOCTYPE html>
<html lang="en">
<head>
			...
			<div class="row">
				<div class="col-md-5">
					<div class="single-product-img">
						<img src="../image/<?php echo $product['Picture_pro']; ?>">
					</div>
				</div>
				<div class="col-md-7">
					<div class="single-product-content">
						<h3><?php echo $product["Name_pro"]; ?></h3>
						<p class="single-product-pricing"><span>Per Kg</span> $<?php echo $product['Price_pro']; ?></p>
						<p><?php echo $product['Quantity_pro']; ?></p>
						<form action="" method="POST">
						<div class="form-group">
                                            <label>Số lượng: </label>
                                            <input class="form-control" type="number" name="txt_quantity" style="width: 150px;" value="1">
                                        </div>
							<button type="submit" name="btn_submit" class="btn btn-danger">Thêm vào giỏ hàng</button>
							<p><strong></strong></p>
						</div>
						</form>
						<br>
				...
				<?php
                    ...
                    if (isset($_POST["btn_submit"])) {
                        if (!empty($_SESSION["UserName"])) {
                            if ($_POST["txt_quantity"] <= $product['Quantity_pro']) {
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 col-md-6 text-center">
					<div class="single-product-item">
						<div class="product-image">
							<a href="single-product.php"><img src="image/product-img-1.jpg" alt=""></a>
						</div>
						<h3>Strawberry</h3>
				...
				<div class="col-lg-4 col-md-6 text-center">
					<div class="single-product-item">
						<div class="product-image">
							<a href="single-product.php"><img src="image/product-img-2.jpg" alt=""></a>
						</div>
						<h3>Berry</h3>
				...
				<div class="col-lg-4 col-md-6 offset-lg-0 offset-md-3 text-center">
					<div class="single-product-item">
						<div class="product-image">
							<a href="single-product.php"><img src="image/product-img-3.jpg" alt=""></a>
						</div>
						<h3>Lemon</h3>
