                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <?php
                                        ...
                                        $user = $data_user->select_user($_SESSION["UserName"])->fetch_assoc();  
                                        $order = $data_user_order->select_last_order()->fetch_assoc();
                                    ?>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr> 
                                                    <td class="info_title">Ngày đặt:</td>
                                        ...
                                        <table class="table table-bordered">
                                            <thead class="thead-light">
                                                <tr>
                                                    <th colspan="4">Danh sách sản phẩm</th>
                                                </tr>
                                                <tr>
                                                    <th>Tên hàng</th>
                                                    <th>Hình ảnh</th>                                                
                                            ...
                                            <tbody>
                                                <?php 
                                                    $order_products = $data_user_order->select_order_pro($order["ID_order"]);
                                                ...
                                                ?>
                                                <tr>
                                                    <td colspan="3" class="info_title" style="text-align: right;"><strong>Tổng tiền :</strong></td>
                                                    <td><?php echo $order["Money_into"] ?>$</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
