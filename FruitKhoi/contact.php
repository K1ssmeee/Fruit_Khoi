				...
				<div class="col-lg-8 mb-5 mb-lg-0">
					...
					<div class="contact-form">
						<form method="POST" id="fruitkha-contact" onSubmit="return valid_datas( this );">
							<p>
								<input type="text" placeholder="Name" name="txt_yourname" id="name">
								<input type="email" placeholder="Email" name="txt_email" id="email">
							</p>
							<p>
								<input type="text" placeholder="Phone" name="txt_phone" id="phone">
								<input type="date" placeholder="date" name="txt_date" id="date">
							</p>
							<p><textarea name="txt_message" id="message" cols="30" rows="10" placeholder="Message"></textarea></p>
							<input type="hidden" name="token" value="FsWga4&@f6aw" />
							<p><input type="submit" name="btn_sub" ></p>
						</form>
					</div>
					<?php
              if(isset($_POST["btn_sub"])) {
                $data_contact = new data_contact();
                if($data_contact->insert_cont($_POST["txt_yourname"], 
                                              $_POST["txt_phone"], 
                                              $_POST["txt_email"], 
                                              $_POST["txt_message"],
                                              $_POST["txt_date"])) 
                {
                  echo "<script> alert('Gửi Contact thành công.');
				...
				<div class="col-lg-4">
					<div class="contact-form-wrap">
						<div class="contact-form-box">
							...
							<p>792 Trương Định<br> HaNoi <br> VietNam</p>
						</div>
						<div class="contact-form-box">
